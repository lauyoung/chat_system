...
(*.[0-9]*)
	...
	if test ! -f /home/lauyang/project/my_chat_system/bages/ncurses-6.0/man_alias.sed ; then
cat >>/home/lauyang/project/my_chat_system/bages/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/lauyang/project/my_chat_system/bages/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/lauyang/project/my_chat_system/bages/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /home/lauyang/project/my_chat_system/bages/ncurses-6.0/man_alias.sed \
		< $i >$TMP
